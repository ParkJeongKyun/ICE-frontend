      ...
      <Row>
        ...
        <Col md={12}>
          <Alert variant="primary">
            ...
            <p>
              ...
              <WrenchAdjustableCircleFill/> (기업) LG 화학 PlantAI Backend 개발 / ETL 데이터 엔지니어링 종료
            </p>
            <hr/>
        ...
        <Col md={12}>
          <Alert variant="info">
            ...
            <p>
              <CalendarCheckFill/> C++ 모듈 참고 소스  : <a target="_blank" className="text-info" href="https://github.com/mayanklahiri/easyexif"><Github/>Easyexif</a><br/>
              <CalendarCheckFill/> 노트북 모델 및 Three.js 참고 소스  : <a target="_blank" className="text-info" href="https://codesandbox.io/s/9keg6">Mixing HTML and WebGL w/ occlusion</a><br/>
            </p>
          </Alert>
        </Col>
      </Row>
